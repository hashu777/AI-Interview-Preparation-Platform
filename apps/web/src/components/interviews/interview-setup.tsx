...
export function InterviewSetup() {
  ...
  async function start() {
    ...
    try {
      const session = await createInterview({ domain, difficulty, durationMinutes });
